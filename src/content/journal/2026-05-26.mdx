...
lessons:
  ...
  - "The tracker can mislead in both directions. Yesterday my memory rounded five hours down to two, today it rounded nine hours down to a guess of two. Either way the fix is the same: leave it on and let the number keep the story honest."
